...
const LinkedAccountModal: React.FC<LinkedAccountModalProps> = ({
    ...
    return (
        <ModalOverlay isOpen={isOpen} onClose={onClose}>
            <div className="p-6">
                <h2 className="text-xl font-bold text-[hsl(158,64%,52%)] mb-4">Thêm tài khoản bạn muốn liên kết</h2>

                <p className="text-sm text-gray-600 mb-4">
                    Lời mời của bạn sẽ được hiển thị dưới tên của bạn (SĐT của bạn) tới SĐT/Email mà bạn muốn liên kết.
                </p>
                ...
                <div className="mb-6">
                    <Label className="text-sm font-medium">
                        Nhập SĐT/email bạn muốn liên kết <span className="text-red-500">*</span>
                    </Label>
                    <Input
