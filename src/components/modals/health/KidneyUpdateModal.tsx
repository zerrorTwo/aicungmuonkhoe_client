...
export interface KidneyUpdatePayload { date: string; value: number; }
...
const KidneyUpdateModal: React.FC<KidneyUpdateModalProps> = ({ isOpen, onClose, onSubmit, initialData }) => {
