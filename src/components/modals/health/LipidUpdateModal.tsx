...
const LipidUpdateModal: React.FC<LipidUpdateModalProps> = ({ isOpen, onClose, onSubmit, initialData }) => {
    ...
    const validate = () => {
        ...
        if (!value || isNaN(v) || v <= 0) e.value = "Chỉ số mỡ máu không hợp lệ";
        setErrors(e);
    ...
    return (
        <ModalOverlay isOpen={isOpen} onClose={onClose}>
            <div className="p-6 max-h-[80vh] overflow-y-auto">
                <h2 className="text-xl font-bold text-foreground mb-4">Cập nhật chỉ số Mỡ máu</h2>
...
export default LipidUpdateModal;
