...
interface LiverUpdateModalProps {
    ...
    initialData?: Partial<LiverUpdatePayload & { id?: number; ID?: number }> | null;
...
const LiverUpdateModal: React.FC<LiverUpdateModalProps> = ({ isOpen, onClose, onSubmit, initialData, healthDocumentId, ageType, activeTab }) => {
    ...
    const validate = () => {
        ...
        if (!value || isNaN(v) || v <= 0) e.value = "Chỉ số gan không hợp lệ";
        setErrors(e);
    ...
    return (
        <ModalOverlay isOpen={isOpen} onClose={onClose}>
            <div className="p-6 max-h-[80vh] overflow-y-auto">
                <h2 className="text-xl font-bold text-foreground mb-4">Cập nhật chức năng gan</h2>
...
export default LiverUpdateModal;
