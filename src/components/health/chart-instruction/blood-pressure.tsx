...
import BloodPressureDetail from '../chart-instruction-detail/blood-pressure';
  ...
  return (
    <div css={rootStyles}>
      ...
      <div css={detailGuideStyles}>
        {isMobile ? (
          <Collapse
            label='Hướng dẫn chi tiết đọc biểu đồ chỉ số Huyết áp'
            content={<BloodPressureDetail />}
            boldActivatedLabel={false}
          />
        ) : (
          <div css={desktopStyles}>
            <div>Hướng dẫn chi tiết đọc biểu đồ chỉ số Huyết áp</div>
            <BloodPressureDetail />
          </div>
        )}
      </div>
