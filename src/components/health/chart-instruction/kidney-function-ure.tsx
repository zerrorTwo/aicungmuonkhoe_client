...
import KidneyFunctionUreDetail from '../chart-instruction-detail/kidney-function-ure';

export default function KidneyFunctionUre() {
  return (
    <div css={rootStyles}>
      ...
      <div css={detailGuideStyles}>
        {isMobile ? (
          <Collapse
            label='Hướng dẫn chi tiết đọc biểu đồ chỉ số Ure'
            content={<KidneyFunctionUreDetail />}
            boldActivatedLabel={false}
          />
        ) : (
          <div css={desktopStyles}>
            <div>Hướng dẫn chi tiết đọc biểu đồ chỉ số Ure</div>
            <KidneyFunctionUreDetail />
          </div>
        )}
      </div>
    </div>
