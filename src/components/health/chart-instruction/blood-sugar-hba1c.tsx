...
import BloodSugarDetailHbA1c from '../chart-instruction-detail/blood-sugar-hba1c';

export default function BloodSugarHbA1c() {
  return (
    <div css={rootStyles}>
      ...
      <div css={detailGuideStyles}>
        {isMobile ? (
          <Collapse
            label='Hướng dẫn chi tiết đọc biểu đồ chỉ số HbA1c'
            content={<BloodSugarDetailHbA1c />}
            boldActivatedLabel={false}
          />
        ) : (
          <div css={desktopStyles}>
            <div>Hướng dẫn chi tiết đọc biểu đồ chỉ số HbA1c</div>
            <BloodSugarDetailHbA1c />
          </div>
        )}
      </div>
    </div>
