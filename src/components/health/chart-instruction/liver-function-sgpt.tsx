...
import LiverFunctionSGPTDetail from '../chart-instruction-detail/liver-function-sgpt';

export default function LiverFunctionSGPT() {
  return (
    <div css={rootStyles}>
      ...
      <div css={detailGuideStyles}>
        {isMobile ? (
          <Collapse
            label='Hướng dẫn chi tiết đọc biểu đồ chỉ số SGPT/ALT'
            content={<LiverFunctionSGPTDetail />}
            boldActivatedLabel={false}
          />
        ) : (
          <div css={desktopStyles}>
            <div>Hướng dẫn chi tiết đọc biểu đồ chỉ số SGPT/ALT</div>
            <LiverFunctionSGPTDetail />
          </div>
        )}
      </div>
    </div>
