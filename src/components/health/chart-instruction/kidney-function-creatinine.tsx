...
import KidneyFunctionCreatinineDetail from '../chart-instruction-detail/kidney-function-creatinine';

export default function KidneyFunctionCreatinine() {
  return (
    <div css={rootStyles}>
      ...
      <div css={detailGuideStyles}>
        {isMobile ? (
          <Collapse
            label='Hướng dẫn chi tiết đọc biểu đồ chỉ số Creatinine'
            content={<KidneyFunctionCreatinineDetail />}
            boldActivatedLabel={false}
          />
        ) : (
          <div css={desktopStyles}>
            <div>Hướng dẫn chi tiết đọc biểu đồ chỉ số Creatinine</div>
            <KidneyFunctionCreatinineDetail />
          </div>
        )}
      </div>
    </div>
