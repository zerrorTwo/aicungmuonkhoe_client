...
import BMIDetailFiveToTwelve from '../chart-instruction-detail/bmi-five-to-twelve';
import { isMobile } from 'react-device-detect';

export default function BMIFiveToTwelve() {
  return (
    <div css={rootStyles}>
      ...
      <div css={detailGuideStyles}>
        {isMobile ? (
          <Collapse
            label='Hướng dẫn đọc biểu đồ BMI trên 5 tuổi đến dưới 12 tuổi'
            content={<BMIDetailFiveToTwelve />}
            boldActivatedLabel={false}
          />
        ) : (
          <div css={desktopStyles}>
            <div>Hướng dẫn đọc biểu đồ BMI trên 5 tuổi đến dưới 12 tuổi</div>
            <BMIDetailFiveToTwelve />
          </div>
        )}
      </div>
    </div>
