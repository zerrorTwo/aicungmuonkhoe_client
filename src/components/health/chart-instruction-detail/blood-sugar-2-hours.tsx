...
export default function BloodSugarDetail2Hours() {
  return (
    <div css={rootStyles}>
      <div css={itemStyles}>
        <strong>Đường huyết sau ăn 2 giờ là gì?</strong>
        <br />
        Đường huyết sau ăn 2 giờ là chỉ số đo nồng độ glucose trong máu tại thời điểm 2 tiếng sau khi bắt đầu bữa ăn.
      </div>
      <div css={itemStyles}>
        <strong>Tác động đến cơ thể:</strong>
        <br />
        Chỉ số này đánh giá khả năng cơ thể dung nạp và xử lý đường sau khi ăn. Mức đường huyết sau ăn cao liên tục làm tăng nguy cơ biến chứng tim mạch.
      </div>
      <div css={itemStyles}>
