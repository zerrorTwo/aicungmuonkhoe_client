...
const Login: React.FC = () => {
  ...
  const [verifyEmailStep, setVerifyEmailStep] = useState<
    "register" | "verify" | null
  >(null)
  ...
  const handleVerifyEmailInputChange = (
      ...
      if (result.status === 200) {
        ...
        if (tempPassword) {
          ...
          if (loginResult.status === 200) {
            ...
            console.log(
              "Auto login successful after verification, navigating to home page..."
            )
            navigate("/", { replace: true })
          } else {
            setError(
              "Xác thực thành công nhưng không thể đăng nhập tự động. Vui lòng đăng nhập thủ công."
            )
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1">
        <div className="flex flex-1 gap-[20px] p-5">
          <div className="flex flex-1 gap-5">
            {/* Left Side - Background Image */}
            <div className="relative hidden max-h-[calc(700px)] lg:flex lg:w-[calc(50%+50px)]">
              <img
            ...
            <div className="flex max-h-[calc(700px)] w-full items-center justify-center overflow-y-auto rounded-xl bg-white p-5 shadow-lg lg:w-[calc(50%-50px)]">
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="relative">
                                  ...
                                  <Input
                                    ...
                                    className="h-11 border-gray-300 pl-10 text-center font-mono tracking-wider focus:border-emerald-500 focus:ring-emerald-500"
                                    placeholder="000000"
                                  />
                                </div>
                              </div>
